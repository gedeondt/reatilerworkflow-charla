...
- Los eventos se nombran en `PascalCase` y los campos en `camelCase`. Los estados de dominio (`set-state.status`) usan mayúsculas o frases cortas en español para facilitar la lectura en la visualización.【F:business/retailer-happy-path.json†L1-L78】
